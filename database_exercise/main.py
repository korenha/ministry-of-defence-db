from database_exercise.db import *
# database1 = db.DataBase()
# table1 = database1.create_table("first",[db.DBField("name",str)],"name")
# table1.insert_record({"name":"name_a"})
# table1.insert_record({"name":"name_b"})
# table1.delete_records([db.SelectionCriteria("name","==","name_a")])
# from database_exercise.test_db import *
...
from database_exercise.db import DataBase
from database_exercise.db_api import DBField, SelectionCriteria, DB_ROOT, DBTable
...
def test_create(new_db: DataBase) -> None:
    ...
    students.delete_record(1_000_000 + 111)
